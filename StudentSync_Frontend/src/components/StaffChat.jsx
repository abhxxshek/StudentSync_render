...
const StaffChat = () => {
  ...
  function fetchChats() {
    axiosInstance
      .get("https://studentsync-render-backend.onrender.com/chat/staff/display-chat")
      .then((res) => {
        setChat(res.data);
      })
      .catch((error) => {
  ...
  function sendReply(item) {
    ...
    axiosInstance
      .put(`https://studentsync-render-backend.onrender.com/chat/reply/${item._id}`,{ answer: reply[item._id] })
      .then((res) => {
